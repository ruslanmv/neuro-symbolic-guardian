...
async def example_inventory_management() -> None:
    ...
    print("=" * 80)
    print("Example 1: Inventory Management with Guardian Verification")
    print("=" * 80)
    ...
    print("\n[Test 1: Valid Operation]")
    result = agent.execute_task_with_verification(
...
async def example_security_operations() -> None:
    ...
    print("\n" + "=" * 80)
    print("Example 2: Security Operations with Guardian Verification")
    print("=" * 80)
...
async def example_multi_agent_workflow() -> None:
    ...
    print("\n" + "=" * 80)
    print("Example 3: Multi-Agent Workflow with Guardian")
    print("=" * 80)
    ...
    print("\n[Phase 1: Planning]")
    plan_result = planner.execute_task_with_verification(
    ...
    print("\n[Phase 2: Execution]")
    execution_result = executor.execute_task_with_verification(
...
def main() -> None:
    """Run all examples."""
    print("\n🛡️  Neuro-Symbolic Guardian + CrewAI Integration Examples\n")
    ...
    if not api_key:
        print("⚠️  Warning: No LLM API key configured. Set environment variables:")
        print("  - For OpenAI: export OPENAI_API_KEY=your-key")
        print("  - For Claude: export ANTHROPIC_API_KEY=your-key")
        print("  - For Watsonx: export WATSONX_API_KEY=your-key and WATSONX_PROJECT_ID=your-id")
        print("  - For Ollama: ensure Ollama is running at http://localhost:11434")
        return

    print(f"✅ Using LLM provider: {llm_settings.provider.value}\n")
